...
public class RegisterActivity extends BaseActivity implements Response.Listener<String>, Response.ErrorListener {
    ...
    protected void applyTheme(int theme) {
        ...
        if (Constants.MODE_NIGHT == theme) {
            ...
            mEmailEdit.setTextColor(getResources().getColor(R.color.text_color_weak));
            mEmailEdit.setHintTextColor(0xFF666666);

            mPasswordEdit.setTextColor(getResources().getColor(R.color.text_color_weak));
            mPasswordEdit.setHintTextColor(0xFF666666);

            mNickNameEdit.setTextColor(getResources().getColor(R.color.text_color_weak));
            mNickNameEdit.setHintTextColor(0xFF666666);
        } else {
            sendBtn.setBackgroundResource(R.drawable.btn_gray);
            sendBtn.setTextColor(getResources().getColor(R.color.text_color_regular));

            mEmailEdit.setTextColor(getResources().getColor(R.color.text_color_regular));
            mEmailEdit.setHintTextColor(0xFF9C9C9C);
            mPasswordEdit.setTextColor(getResources().getColor(R.color.text_color_regular));
            mPasswordEdit.setHintTextColor(0xFF9C9C9C);
            mNickNameEdit.setTextColor(getResources().getColor(R.color.text_color_regular));
            mNickNameEdit.setHintTextColor(0xFF9C9C9C);
        }
    }
}
