 ...
 *
 * The simple way to use this class is to call {@link volley.toolbox.ImageLoader#get(String, volley.toolbox.ImageLoader.ImageListener)}
 * and to pass in the default image listener provided by
 * {@link volley.toolbox.ImageLoader#getImageListener(android.widget.ImageView, int, int)}. Note that all function calls to
...
public class ImageLoader {
     ...
     * If the default was returned, the {@link volley.toolbox.ImageLoader} will be invoked when the
